...
export default async function Corte({ searchParams }) {
  ...
  const filteredPosts = posts.filter(
    (post) =>
      post.categoria === "Ferramentas de Corte" &&
  ...
  const makePageLink = (page) =>
    `/corte?${searchTerm ? `busca=${searchTerm}&` : ""}page=${page}`;
  ...
  return (
    <div>
      ...
      <div className="max-w-7xl mx-auto py-24 p-5 xl:p-10">
        ...
        <h1 className="text-3xl font-semibold mb-9">Ferramentas de Corte</h1>
